        ...
        return (
            <>
                <nav className="navbar navbar-expand-lg navbar-dark">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent" style={{ disply: "flex", justifyItems: "center", justifyContent: "flex-end" }}>
                        <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown px-3">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li className="py-1"><NavLink className="dropdown-item" style={{ backgroundColor: 'white', color: 'black' }} to="/">Main Board</NavLink></li>
